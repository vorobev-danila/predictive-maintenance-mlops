...
def prepare_data(train_with_rul, top_sensors):
    ...
    train_units, temp_units = train_test_split(unique_units, test_size=0.3, random_state=42)
    ...
    return X_train_scaled, X_val_scaled, X_test_scaled, y_train, y_val, y_test, scaler, base_features